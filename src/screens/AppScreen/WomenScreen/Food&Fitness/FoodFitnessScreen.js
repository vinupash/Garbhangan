...
// const FoodFitnessScreen = () => {
//     return (
//         <View>
//             <Text>Food&FitnessScreen</Text>
//         </View>
//     )
// }

// export default FoodFitnessScreen
...
const FoodFitnessScreen = ({ navigation }) => {
            ...
            >
                <View style={{ flexDirection: 'column', height: '100%', alignItems: 'center' }}>
                    ...
                    <View style={styles.btnBox}>
                        <LanguageTab
                            title="English"
                            onPress={() => navigation.navigate('FoodFitnessStack', { screen: 'FoodFitnessEnglishScreen' })}
                        />

                        <LanguageTab
                            title="मराठी"
                            onPress={() => navigation.navigate('FoodFitnessStack', { screen: 'FoodFitnessMarathiScreen' })}
                        />

                        <LanguageTab
                            title="हिंदी"
                            onPress={() => navigation.navigate('FoodFitnessStack', { screen: 'FoodFitnessHindiScreen' })}
                        />
                    </View>
                </View>
            </ImageBackground>
