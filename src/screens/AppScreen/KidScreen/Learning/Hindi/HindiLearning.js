...
const HindiLearning = ({ navigation }) => {
                ...
                <View style={{ flexDirection: 'column', justifyContent: 'space-between', height: '100%', alignItems: 'center' }}>
                    ...
                    >
                        <View style={styles.cardSection}>
                            <EducationTab
                                title="अनुप्रास"
                                onPress={() => navigation.navigate('HindiLearningStack', { screen: 'HindiRhymes' })}
                            />

                            <EducationTab
                                title="कहानी"
                                onPress={() => navigation.navigate('HindiLearningStack', { screen: 'HindiStory' })}
                            />

                            {/* <EducationTab
                                title="वर्णमाला"
                                onPress={() => navigation.navigate('HindiLearningStack', { screen: 'HindiAlphabet' })}
                            /> */}
                            ...
                            <EducationTab
                                ...
                                onPress={() => navigation.navigate('HindiLearningStack', { screen: 'HindiGeneral' })}
                            />
                        </View>
                    </ScrollView>
                </View>
