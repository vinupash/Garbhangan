                ...
                <View style={{ flexDirection: 'column', justifyContent: 'space-between', height: '100%', alignItems: 'center' }}>
                    ...
                    >
                        <View style={styles.cardSection}>
                            <EducationTab
                                title="यमक"
                                onPress={() => navigation.navigate('MarathiLearningStack', { screen: 'MarathiRhymes' })}
                            />

                            <EducationTab
                                title="कथा"
                                onPress={() => navigation.navigate('MarathiLearningStack', { screen: 'MarathiStory' })}
                            />

                            {/* <EducationTab
                                title="वर्णमाला"
                                onPress={() => navigation.navigate('MarathiLearningStack', { screen: 'MarathiAlphabet' })}
                            /> */}
                            ...
                            <EducationTab
                                ...
                                onPress={() => navigation.navigate('MarathiLearningStack', { screen: 'MarathiGeneral' })}
                            />
                        </View>
                    </ScrollView>
                </View>
