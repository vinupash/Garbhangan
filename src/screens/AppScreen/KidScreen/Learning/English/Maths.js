...
import DayOfTheWeek from '../../../../../../assets/images/videos/English/Maths/Day-of-The-Week.jpg'
import WorksheetMaths from '../../../../../../assets/images/videos/English/Maths/Worksheet-maths.jpg'
...
const Maths = ({ navigation }) => {
    ...
    const options = [
        ...
        {
            key: 2,
            title: 'Worksheet Maths',
            poster: WorksheetMaths,
            video: 2
        },
    ];
                ...
                <View style={styles.boxContent} key={i}>
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('EnglishLearningStack', {
                            screen: 'EnglishMathsVideoScreen',
